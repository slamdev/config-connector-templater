...
// PubSubSubscriptionTemplateReconciler reconciles a PubSubSubscriptionTemplate object
type PubSubSubscriptionTemplateReconciler struct {
	client.Client
...
// the PubSubSubscriptionTemplate object against the actual cluster state, and then
// perform operations to make the cluster state reflect the state specified by
// the user.
//
// For more details, check Reconcile and its Result here:
// - https://pkg.go.dev/sigs.k8s.io/controller-runtime@v0.8.3/pkg/reconcile
func (r *PubSubSubscriptionTemplateReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
...
func (r *PubSubSubscriptionTemplateReconciler) SetupWithManager(mgr ctrl.Manager) error {
	return ctrl.NewControllerManagedBy(mgr).
		For(&configconnectortemplaterv1alpha1.PubSubSubscriptionTemplate{}).
		Owns(&v1beta1.PubSubSubscription{}).
		Complete(r)
}
